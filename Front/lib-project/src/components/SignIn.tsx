...
import { openWindowSignIn,signIn,openWindowCreateAccount} from '../store/userSlice';
...
export default function SignIn(){
    ...
    <BackgroundForm>
        <InputForm>
            <H1>Sign in</H1>
            <H2>Use your Library Account</H2>
            <DivInput>
            ...
            <ButtonSignIn
            onClick={()=>dispatch(signIn("ssss"))}>
                Sign in to Library    
            </ButtonSignIn>
            <ButtonRecover>
                Recover your password
            </ButtonRecover>
            <H6 style={{marginBottom:"-20px"}}>No profile on Library?</H6>
            <ButtonRegistration
            onClick={()=>dispatch(openWindowCreateAccount())}>
                Registration
            </ButtonRegistration>
        </InputForm>
        <Tooltip title="Close the authorization window">
            <ButtonClose onClick={()=>dispatch(openWindowSignIn())}/>
        </Tooltip>
    </BackgroundForm>
    );
}